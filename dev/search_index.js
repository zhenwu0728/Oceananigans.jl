...

{
    ...
    "title": "GPU example",
    "category": "section",
    "text": "If you have access to an Nvidia CUDA-enabled graphics processing unit (GPU) you can run ocean models on it! Just pass arch=GPU() as a keyword argument when constructing the model:model = Model(N=(Nx, Ny, Nz), L=(Lx, Ly, Lz), arch=GPU())"
},
