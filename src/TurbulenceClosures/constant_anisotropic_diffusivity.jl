...
calculate_diffusivities!(K, grid, closure::ConstantAnisotropicDiffusivity, args...) = nothing
...
@inline function ∇_κ_∇c(i, j, k, grid, c, ::Val{tracer_index}, closure::ConstantAnisotropicDiffusivity, 
                        args...) where tracer_index
